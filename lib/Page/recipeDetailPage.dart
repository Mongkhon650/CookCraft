    ...
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          final String userId = recipeData['user_id'] ?? ''; // เปลี่ยนเป็น String
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(recipeData['name'] ?? "ไม่มีชื่อ", style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 8),

                      // 🔹 ดึงชื่อผู้ใช้จาก Firestore ผ่าน user_id (String)
                      ...
                      FutureBuilder<QuerySnapshot>(
                        ...
                        builder: (context, ingredientSnapshot) {
                          ...
                          if (!ingredientSnapshot.hasData || ingredientSnapshot.data!.docs.isEmpty) {
                            return const Text("ไม่มีข้อมูลส่วนผสม");
                          }
                          ...
                          return Column(
                            ...
                            children: ingredientSnapshot.data!.docs.map((doc) {
                              ...
                              final amount = data['quantity']['amount']?.toString() ?? "ไม่ระบุ";
                              final unit = data['quantity']['unit'] ?? "ไม่ระบุ";
                      ...
                      FutureBuilder<QuerySnapshot>(
                        ...
                        builder: (context, stepsSnapshot) {
                          ...
                          if (!stepsSnapshot.hasData || stepsSnapshot.data!.docs.isEmpty) {
                            return const Text("ไม่มีข้อมูลขั้นตอนการทำ");
                          }
